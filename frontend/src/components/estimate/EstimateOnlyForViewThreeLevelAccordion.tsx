                                ...
                                <>
                                    <DataTableComponent
                                        ...
                                        columns={[
                                            ...
                                            { field: 'itemMeasurementUnitLabel', headerName: t('Unit'), headerAlign: 'center', align: 'center', flex: 0.2, disableColumnMenu: true },
                                            // { field: 'quantity', headerName: 'Quantity', headerAlign: 'left', width: 120, editable: true, cellClassName: 'editableCell' },
                                            { field: 'quantity', headerName: t('Quantity'), headerAlign: 'center', align: 'center', flex: 0.2, editable: (session?.user && permissionsSet?.has?.('EST_EDT_LBR_QTY') && !props.viewOnly), cellClassName: (session?.user && permissionsSet?.has?.('EST_EDT_LBR_QTY') && !props.viewOnly) ? 'editableCell' : '', disableColumnMenu: true, valueFormatter: (value) => formatCurrency(value) },
                                            // { field: 'itemChangableAveragePrice', headerName: 'Price', headerAlign: 'left', width: 120, editable: true, cellClassName: 'editableCell'},
                                            { field: 'itemChangableAveragePrice', headerName: t('Price'), headerAlign: 'center', align: 'center', flex: 0.3, disableColumnMenu: true, valueFormatter: (value) => formatCurrency(value) },
                                            { field: 'itemWithoutMaterial', headerName: t('Without material'), headerAlign: 'center', align: 'center', flex: 0.4, disableColumnMenu: true, valueFormatter: (value) => formatCurrency(value) },
                                            { field: 'materialTotalCost', headerName: t('Material Cost'), headerAlign: 'center', align: 'center', flex: 0.4, disableColumnMenu: true, valueFormatter: (value) => formatCurrency(value) },
                                            { field: 'priceWithMaterial', headerName: t('Price with material'), headerAlign: 'center', align: 'center', flex: 0.5, disableColumnMenu: true, valueFormatter: (value) => formatCurrency(value) },
                                                    ...
                                                    <>
                                                        <DataTableComponent
                                                            ...
                                                            columns={[
                                                                ...
                                                                { field: 'itemMeasurementUnitLabel', headerName: t('Unit'), headerAlign: 'center', align: 'center', flex: 0.15, disableColumnMenu: true },
                                                                // { field: 'quantity', headerName: 'Quantity', headerAlign: 'left', width: 120, editable: true, cellClassName: 'editableCell', },
                                                                { field: 'quantity', headerName: t('Quantity'), headerAlign: 'center', align: 'center', flex: 0.2, editable: (session?.user && permissionsSet?.has?.('EST_EDT_LBR_QTY') && props.viewOnly), cellClassName: (session?.user && permissionsSet?.has?.('EST_EDT_LBR_QTY') && !props.viewOnly) ? 'editableCell' : '', disableColumnMenu: true, valueFormatter: (value) => formatCurrency(value) },
                                                                // { field: 'itemChangableAveragePrice', headerName: 'Price', headerAlign: 'left', width: 120, editable: true, cellClassName: 'editableCell', },
                                                                { field: 'itemChangableAveragePrice', headerName: t('Price'), headerAlign: 'center', align: 'center', flex: 0.25, disableColumnMenu: true, valueFormatter: (value) => formatCurrency(value) },
