                                                    ...
                                                    {child.isLoading ? (
                                                        ...
                                                        child.children && child.children.length > 0 ? (
                                                            <Stack spacing={0.5} sx={{ ml: 4 }}>
                                                                ...
                                                                <DataTableComponent
                                                                    sx={{ width: '100%', backgroundColor: 'transparent', '& .MuiDataGrid-main': { backgroundColor: 'transparent' }, '& .MuiDataGrid-columnHeaders': { backgroundColor: 'transparent' }, '& .MuiDataGrid-columnHeader': { backgroundColor: 'transparent !important' }, '& .MuiDataGrid-virtualScroller': { backgroundColor: 'transparent' }, '& .MuiDataGrid-row': { backgroundColor: 'transparent' }, '& .MuiDataGrid-cell': { backgroundColor: 'transparent' }, '& .MuiDataGrid-footerContainer': { backgroundColor: 'transparent' }, '& .MuiDataGrid-row:hover': { backgroundColor: '#E8EFEF !important' }, '& .MuiDataGrid-filler': { backgroundColor: 'transparent' } }}
                                                                    columns={[
