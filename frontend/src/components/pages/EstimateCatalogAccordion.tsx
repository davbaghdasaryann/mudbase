                                                    ...
                                                    {child.isLoading ? (
                                                        ...
                                                        child.children && child.children.length > 0 ? (
                                                            <Stack spacing={0.5} sx={{ ml: 4 }}>
                                                                ...
                                                                <DataTableComponent
                                                                    sx={{ width: '100%', '--DataGrid-containerBackground': 'transparent', backgroundColor: 'transparent', '& .MuiDataGrid-main': { backgroundColor: 'transparent' }, '& .MuiDataGrid-columnHeaders': { backgroundColor: 'transparent' }, '& .MuiDataGrid-columnHeader': { backgroundColor: 'transparent !important' }, '& .MuiDataGrid-virtualScroller': { backgroundColor: 'transparent' }, '& .MuiDataGrid-virtualScrollerContent': { backgroundColor: 'transparent' }, '& .MuiDataGrid-virtualScrollerRenderZone': { backgroundColor: 'transparent' }, '& .MuiDataGrid-row': { backgroundColor: 'transparent !important' }, '& .MuiDataGrid-cell': { backgroundColor: 'transparent !important', alignItems: 'flex-start' }, '& .MuiDataGrid-footerContainer': { backgroundColor: 'transparent' }, '& .MuiDataGrid-row:hover': { backgroundColor: '#E8EFEF !important' }, '& .MuiDataGrid-filler': { backgroundColor: 'transparent' } }}
                                                                    getRowHeight={() => 'auto'}
                                                                    columns={[
                                                                        ...
                                                                        { field: 'label', headerName: t('Name'), headerAlign: 'left', flex: 0.5, disableColumnMenu: true, renderCell: (params) => <span style={{ whiteSpace: 'normal', wordBreak: 'break-word', lineHeight: 1.4, padding: '6px 0', display: 'block' }}>{params.value}</span> },
