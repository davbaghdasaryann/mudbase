                                                ...
                                                {groupItems.length > 0 && (
                                                    <Box sx={{
                                                        ...
                                                        background: isCollapsed
                                                            ? `linear-gradient(90deg, ${groupColor} 0%, ${groupColor}cc 100%)`
                                                            : `repeating-linear-gradient(90deg, ${groupColor}80 0px, ${groupColor}80 6px, transparent 6px, transparent 10px)`,
                                                        borderRadius: '4px',
