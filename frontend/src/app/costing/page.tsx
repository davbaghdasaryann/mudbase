                    ...
                    <Box sx={{ flex: 1, overflow: 'auto', minHeight: 0 }}>
                        ...
                        {!collapsedSections.has('quick') && <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', mb: 4 }}>
                            {[
                                ...
                                { icon: <ChangeCircleOutlinedIcon sx={{ fontSize: 30, color: '#f57c00', opacity: 0.55 }} />, label: 'Աշkhataanqi phopokhutyun', onClick: () => {}, accent: '#f57c00', hoverBg: 'rgba(245,124,0,0.06)' },
                                { icon: <PrecisionManufacturingOutlinedIcon sx={{ fontSize: 30, color: '#795548', opacity: 0.55 }} />, label: 'Mexanizmi tsakhsagrum', onClick: () => {}, accent: '#795548', hoverBg: 'rgba(121,85,72,0.06)' },
                                { icon: <SummarizeOutlinedIcon sx={{ fontSize: 30, color: '#0288d1', opacity: 0.55 }} />, label: 'Ամphoph hashvark', onClick: () => {}, accent: '#0288d1', hoverBg: 'rgba(2,136,209,0.06)' },
