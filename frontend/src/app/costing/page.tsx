                    ...
                    <Box sx={{ flex: 1, overflow: 'auto', minHeight: 0 }}>
                        ...
                        <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', mb: 4 }}>
                            {[
                                ...
                                { icon: <AccountBalanceWalletOutlinedIcon sx={{ fontSize: 30, color: '#6A1B9A' }} />, label: t('Salary Cost Recording'), onClick: () => setSalaryOpen(true), accent: '#6A1B9A', hoverBg: 'rgba(106,27,154,0.06)' },
                                ...
                                { icon: <AddCardOutlinedIcon sx={{ fontSize: 30, color: '#1565c0' }} />, label: 'Այլ ծախսեր', onClick: () => setOtherCostsOpen(true), accent: '#2E7D32', hoverBg: 'rgba(46,125,50,0.06)' },
