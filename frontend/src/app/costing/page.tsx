                ...
                {tab === 'general' && (
                    <Box sx={{ flex: 1, overflow: 'auto', minHeight: 0 }}>
                        ...
                        <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', mb: 4 }}>
                            {[
                                { icon: <CategoryOutlinedIcon sx={{ fontSize: 30, color: mainPrimaryColor }} />, label: t('Materials Cost Recording'), onClick: () => setMaterialsOpen(true), accent: mainPrimaryColor, hoverBg: 'rgba(0,171,190,0.06)' },
                                { icon: <AccountBalanceWalletOutlinedIcon sx={{ fontSize: 30, color: mainPrimaryColor }} />, label: t('Salary Cost Recording'), onClick: () => setSalaryOpen(true), accent: mainPrimaryColor, hoverBg: 'rgba(0,171,190,0.06)' },
                                { icon: <StraightenIcon sx={{ fontSize: 30, color: mainPrimaryColor }} />, label: t('Volume Registration'), onClick: () => setVolumesOpen(true), accent: mainPrimaryColor, hoverBg: 'rgba(0,171,190,0.06)' },
                                { icon: <BuildIcon sx={{ fontSize: 30, color: '#1565c0' }} />, label: 'Փոքրածավալ', onClick: () => setSmallScaleOpen(true), accent: '#1565c0', hoverBg: 'rgba(21,101,192,0.06)' },
                                { icon: <AddCardOutlinedIcon sx={{ fontSize: 30, color: '#1565c0' }} />, label: 'Այլ ծախսեր', onClick: () => setOtherCostsOpen(true), accent: '#1565c0', hoverBg: 'rgba(21,101,192,0.06)' },
