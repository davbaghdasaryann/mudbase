                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, pt: 0.5, pb: 1 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, px: 2, py: 2, bgcolor: '#f5f5f5', borderRadius: 2, transition: 'background-color 0.15s', '&:hover': { bgcolor: '#ebebeb' } }}>
                            ...
                            <Box sx={{ display: 'flex', gap: 0.5, ml: 1 }}>
                                <Tooltip title='HTML'><IconButton sx={{ color: '#e65100', opacity: 0.75, '&:hover': { opacity: 1, bgcolor: 'rgba(230,81,0,0.08)' } }} onClick={() => handleWarehouseExportAs('html')}><CodeOutlinedIcon sx={{ fontSize: 24 }} /></IconButton></Tooltip>
                                <Tooltip title='Word'><IconButton sx={{ color: '#1565c0', opacity: 0.75, '&:hover': { opacity: 1, bgcolor: 'rgba(21,101,192,0.08)' } }} onClick={() => handleWarehouseExportAs('word')}><ArticleOutlinedIcon sx={{ fontSize: 24 }} /></IconButton></Tooltip>
                                <Tooltip title='Excel'><IconButton sx={{ color: '#2e7d32', opacity: 0.75, '&:hover': { opacity: 1, bgcolor: 'rgba(46,125,50,0.08)' } }} onClick={() => handleWarehouseExportAs('excel')}><TableChartOutlinedIcon sx={{ fontSize: 24 }} /></IconButton></Tooltip>
