    ...
    const buildSummaryHtml = async (): Promise<string> => {
        ...
        for (let si = 0; si < sections.length; si++) {
            ...
            const renderLaborRow = (row: SnapshotLaborRow) => {
                ...
                // Skip rows with no costs (volume-only or empty group)
                ...
                <DialogContent>
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, pt: 0.5, pb: 1 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, px: 2, py: 2, bgcolor: '#f5f5f5', borderRadius: 2, transition: 'background-color 0.15s', '&:hover': { bgcolor: '#ebebeb' } }}>
                            ...
                            <Box sx={{ display: 'flex', gap: 1, ml: 1 }}><Box onClick={() => handleWarehouseExportAs('html')} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(230,81,0,0.06)' } }}><CodeOutlinedIcon sx={{ fontSize: 20, color: '#e65100', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#e65100', opacity: 0.9, mt: 0.3 }}>HTML</Typography></Box><Box onClick={() => handleWarehouseExportAs('word')} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(21,101,192,0.06)' } }}><ArticleOutlinedIcon sx={{ fontSize: 20, color: '#1565c0', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#1565c0', opacity: 0.9, mt: 0.3 }}>Word</Typography></Box><Box onClick={() => handleWarehouseExportAs('excel')} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(46,125,50,0.06)' } }}><TableChartOutlinedIcon sx={{ fontSize: 20, color: '#2e7d32', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#2e7d32', opacity: 0.9, mt: 0.3 }}>Excel</Typography></Box><Box onClick={() => handleWarehouseExportAs('pdf')} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(229,57,53,0.06)' } }}><PictureAsPdfOutlinedIcon sx={{ fontSize: 20, color: '#e53935', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#e53935', opacity: 0.9, mt: 0.3 }}>PDF</Typography></Box></Box>
                        </Box>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, px: 2, py: 2, bgcolor: '#f5f5f5', borderRadius: 2, transition: 'background-color 0.15s', '&:hover': { bgcolor: '#ebebeb' } }}>
                            ...
                            <Box sx={{ display: 'flex', gap: 1, ml: 1 }}><Box onClick={() => { setExportFormat('html'); setExportTypes(new Set(HISTORY_TYPE_GROUPS.filter(g => costHistory.some(e => g.match(e.paymentMethod ?? '', e.isSubcontractor))).map(g => g.key))); setExportOpen(true); setDocumentsOpen(false); }} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(230,81,0,0.06)' } }}><CodeOutlinedIcon sx={{ fontSize: 20, color: '#e65100', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#e65100', opacity: 0.9, mt: 0.3 }}>HTML</Typography></Box><Box onClick={() => { setExportFormat('word'); setExportTypes(new Set(HISTORY_TYPE_GROUPS.filter(g => costHistory.some(e => g.match(e.paymentMethod ?? '', e.isSubcontractor))).map(g => g.key))); setExportOpen(true); setDocumentsOpen(false); }} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(21,101,192,0.06)' } }}><ArticleOutlinedIcon sx={{ fontSize: 20, color: '#1565c0', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#1565c0', opacity: 0.9, mt: 0.3 }}>Word</Typography></Box><Box onClick={() => { setExportFormat('excel'); setExportTypes(new Set(HISTORY_TYPE_GROUPS.filter(g => costHistory.some(e => g.match(e.paymentMethod ?? '', e.isSubcontractor))).map(g => g.key))); setExportOpen(true); setDocumentsOpen(false); }} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(46,125,50,0.06)' } }}><TableChartOutlinedIcon sx={{ fontSize: 20, color: '#2e7d32', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#2e7d32', opacity: 0.9, mt: 0.3 }}>Excel</Typography></Box><Box onClick={() => { setExportFormat('pdf'); setExportTypes(new Set(HISTORY_TYPE_GROUPS.filter(g => costHistory.some(e => g.match(e.paymentMethod ?? '', e.isSubcontractor))).map(g => g.key))); setExportOpen(true); setDocumentsOpen(false); }} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(229,57,53,0.06)' } }}><PictureAsPdfOutlinedIcon sx={{ fontSize: 20, color: '#e53935', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#e53935', opacity: 0.9, mt: 0.3 }}>PDF</Typography></Box></Box>
                        </Box>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, px: 2, py: 2, bgcolor: '#f5f5f5', borderRadius: 2, transition: 'background-color 0.15s', '&:hover': { bgcolor: '#ebebeb' } }}>
                            ...
                            <Box sx={{ display: 'flex', gap: 1, ml: 1 }}><Box onClick={() => { setDocumentsOpen(false); handleSummaryExportAs('html'); }} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(230,81,0,0.06)' } }}><CodeOutlinedIcon sx={{ fontSize: 20, color: '#e65100', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#e65100', opacity: 0.9, mt: 0.3 }}>HTML</Typography></Box><Box onClick={() => { setDocumentsOpen(false); handleSummaryExportAs('word'); }} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(21,101,192,0.06)' } }}><ArticleOutlinedIcon sx={{ fontSize: 20, color: '#1565c0', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#1565c0', opacity: 0.9, mt: 0.3 }}>Word</Typography></Box><Box onClick={() => { setDocumentsOpen(false); handleSummaryExportAs('excel'); }} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(46,125,50,0.06)' } }}><TableChartOutlinedIcon sx={{ fontSize: 20, color: '#2e7d32', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#2e7d32', opacity: 0.9, mt: 0.3 }}>Excel</Typography></Box><Box onClick={() => { setDocumentsOpen(false); handleSummaryExportAs('pdf'); }} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 0.3, width: 52, height: 52, bgcolor: '#fff', borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer', transition: 'box-shadow 0.2s, transform 0.15s', '&:hover': { boxShadow: '0 4px 16px rgba(0,0,0,0.13)', transform: 'translateY(-2px)', bgcolor: 'rgba(229,57,53,0.06)' } }}><PictureAsPdfOutlinedIcon sx={{ fontSize: 20, color: '#e53935', opacity: 0.75 }} /><Typography sx={{ fontSize: '0.58rem', fontWeight: 700, color: '#e53935', opacity: 0.9, mt: 0.3 }}>PDF</Typography></Box></Box>
                        </Box>
                    </Box>
                </DialogContent>
