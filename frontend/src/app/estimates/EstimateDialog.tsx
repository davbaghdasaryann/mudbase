                        ...
                        <Box data-toolbar="true" sx={{
                            ...
                            {[
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <Typography variant="caption" align="center" sx={{ fontWeight: 500, fontSize: '11px', display: 'flex', alignItems: 'flex-start', justifyContent: 'center' }}>
                                            {t(tool.labelKey)}
                                        </Typography>
                                    </Box>
                                );
                            ...
                            {[
                                ...
                                >
                                    ...
                                    <Typography variant="caption" align="center" sx={{ fontWeight: 500, fontSize: '0.65rem', display: 'flex', alignItems: 'flex-start', justifyContent: 'center' }}>
                                        {t(tool.labelKey)}
                                    </Typography>
                                </Box>
                            ))}
