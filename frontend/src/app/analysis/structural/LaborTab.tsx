...
import { Box, Button, Typography, CircularProgress, Table, TableBody, TableRow, TableCell, TableHead, Dialog, DialogTitle, DialogContent, DialogActions, Switch, Divider, IconButton } from '@mui/material';
    ...
    const handleExport = useCallback((libraryNames: boolean) => {
        ...
        for (const g of groups) {
            ...
            for (const item of g.items) {
                const itemName = libraryNames ? item.catalogName : (item.laborOfferItemName || item.catalogName);
                html += `<tr>` +
